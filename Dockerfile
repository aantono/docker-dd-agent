...
# Install the Agent
ADD https://1490-34269086-gh.circle-artifacts.com/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.11.0.git.82.85257e5-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.11.0.git.82.85257e5-1_amd64.deb && rm /datadog-agent_5.11.0.git.82.85257e5-1_amd64.deb
